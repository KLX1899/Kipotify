...
class TrackRepositoryImpl(
    ...
    override suspend fun refreshTracks(search: String?, genre: String?): Result<List<Track>> {
    ...
    override suspend fun toggleLike(trackId: String): Result<Boolean> = withContext(Dispatchers.IO) {
        runCatching {
    ...
    override suspend fun recordPlay(trackId: String): Result<Unit> = withContext(Dispatchers.IO) {
        runCatching {
    ...
    override suspend fun downloadTrack(trackId: String, onProgress: (Int) -> Unit): Boolean = withContext(Dispatchers.IO) {
    ...
    override suspend fun removeDownload(trackId: String) = withContext(Dispatchers.IO) {
